...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        ...
        <title>Order Completed | British Polo</title>
		...
		<style>
				...
				.button:hover {background-color: lawngreen}
    ...
    <body>
		...
		<center><img src="image/success-tick-dribbble.gif" alt="" style="width:515px;height:380px;"></center>
		<center><h1 style="font-family: Lucida Bright">Payment Successful !</h1></center><br>
		<center><h2 style="font-family: Lucida Bright">Hooray! You have completed your payment.</h2></center><br><br><br>
		<center><a href="orders.php"><button class="button">View Order</button></a></center>
