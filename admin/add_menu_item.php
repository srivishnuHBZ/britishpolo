...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        ...
        <title>Add Items | British Polo</title>
            ...
            <p class="msg_error" style="padding:5px;"><?php echo @$_GET['erro']; ?></p>
                ...
                <div class="my_form1">
                    ...
                    <div>
                        ...
                        <textarea required minlength="6" name="desc_n"></textarea>
                    </div>
                    <div>
                        <label>Price</label>
                        <input type="number" step="0.01" required  name="price" />
                    </div>
                    <!-- Original Ranking Code
					<div>
                        <label>Ranking (Popularity) <small> 0 - 10</small></label>
                        <select required  name="class"><option value=""></option><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option><option value="4">4</option><option value="5">5</option><option value="6">6</option><option value="7">7</option><option value="8">8</option><option value="9">9</option><option value="10">10</option></select>
                    </div>-->
					<div>
                        <label>Ranking (New Arrival)</label>
                        <select required  name="class"><option value="0">0</option><option value="1">1</option><option value="2">2</option><option value="3">3</option></select>
                    </div>
                    <div>
                        <label>Upload Photo</label>
                        <input class="upload" type="file" required  name="image"/>
                    </div>
                    <div>
