...
<html xmlns="http://www.w3.org/1999/xhtml"
    ...
    <head>
        ...
        <title>My Orders - British Polo</title>
        ...
        <div class="small-container cart-page">
            <table >
                ...
                <tr>
                    ...
                    <a  style="background-color:#007aff; color:#FFF; padding:4px;" href="order.php?order_id=<?php echo $order['order_id']; ?>">Order Receipt</a></td>
                    <td><?php echo $order['fname']; ?></td>
                    <td><?php echo $order['email']; ?></td>
                    <td>
                    <?php echo $order['billing_details']; ?>
                    </td>
                    <td>RM<?php echo $order['amount']; ?></td>
         ...
         <p style="text-align:center; padding:150px 40px; font-size:24px;"> You have not made any orders yet &nbsp;<i class="fas fa-heart-broken"></i></p>
